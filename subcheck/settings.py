"""
Django settings for subcheck project.
...
SECRET_KEY = 'django-insecure-3c-)(7lljgr%4k@10^)k2mo0s$-(1+xu9@r649l*rnua^wtkpw'
...
ALLOWED_HOSTS = [
    ...
    'subcheck-production.up.railway.app',  # Agrega el dominio de Railway
...
WSGI_APPLICATION = 'subcheck.wsgi.application'
